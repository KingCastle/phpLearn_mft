<?php include "../header.php"; ?>
  ...
  <ul>
      ...
      <a href="#">تقویم رومیزی اروپایی</a></li>
      ...
      <a href="#">تقویم گرافیکی</a>
      <ul class="sub-menu">
        <li><a href="#">تقویم گرافیکی 1</a></li>
        <li><a href="#">تقویم گرافیکی 2</a></li>
        <li><a href="#">تقویم گرافیکی 3</a></li>
      </ul>
    </li>
      <li>
      <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
